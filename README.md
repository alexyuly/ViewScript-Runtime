...
1. 🧩 Arrangement
  1. Click units to select them
  1. Drag units to reorder them
2. 🎨 Refinement
  1. Click units to select them
  1. Hover units and areas around and between units to view helpful tooltips
3. 🚘 Testing
  1. Interact with the app as if it were running in a browser
